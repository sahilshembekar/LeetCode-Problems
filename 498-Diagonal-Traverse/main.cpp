// https://leetcode.com/problems/diagonal-traverse/
        ...
        if (r == m-1) {//when traversing top to bottom diagonally, at one point we reach the coloumn=0, then we increment our row by 1, at one time when row becomes row+1, we get out of bound. To manage this we have this order of if else.
