...
public:
    ...
    void helper(TreeNode* root, int targetSum, vector<int> path) {
        ...
        if (root->left == NULL && root->right == NULL) { //If yes then this is the leaf node
...
public:
    ...
    void helper(TreeNode* root, int targetSum, vector<int> &path) {
        ...
        //When a vector is passed by reference to a function, it can change your contents of the vector. 
        //More efficient than pass by value as copying of vector is avoided.
